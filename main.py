...
# Visit https://github.com/THETITAN220/GenServices for the latest version and other info
# ---------------------------------------------------Import statements-------------------------------------------------- #
import sys
#pip install PyQt5  
...
try:
    db = mysql.connector.connect(host='localhost', user = 'admin_GenServices', passwd = 'admin@password@GenServices', database = 'GenServices')
